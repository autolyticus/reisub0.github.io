...
I first came across this concept in the excellent [IntermezzOS Book](https://intermezzos.github.io/book/second-edition/fractal-learning.html). It beautifully encapsulates the challenges of students and researchers working to make sense of complex systems:
...
I hope you get why I called it falling down the rabbit hole; you're just digging deeper and deeper onto a specific topic and not really taking a step back and exploring other related topics before going deeper. This is a laser-focused strategy that focuses on exclusion. It's the equivalent of the child who keeps asking "Why?" for a specific topic until she can no longer get a meaningful answer. If someone followed only this strategy for learning about things, she would have very detailed and specific knowledge about some things but have absolutely no idea about even closely related things.
...
Here it is again, in the maze context[ref][Source](https://coderscat.com/breadth-first-searchbfs-explained-with-visualization)[/ref]:
